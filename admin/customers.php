                        ...
                        <div class="btn-group pull-right">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-info btn-sm dropdown-toggle"
                                    data-toggle="dropdown">Exportar</button>
                                <div class="dropdown-menu">
                                    <a href="pdf.php" target="_blank" class="dropdown-item"><i
                                            class="fas fa-file-pdf "></i> PDF</a>
                                    <a href="excel.php" target="_blank" class="dropdown-item"><i
                                        ...
                                        <table class="table table-striped table-bordered" id="example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php
                                                            if ($avatar == null) { ?>
                                                        <img src="../assets/admin/images/portrait/small/avatar.jpg"
                                                            alt="avatar"
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        success: function(inputValue) {
                            swal("Eliminado!", "Tu registro ha sido elimando.",
                                "success");
