<div class="sidenav-overlay"></div>
    ...
    <footer class="footer footer-static footer-light navbar-shadow">
        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">Copyright &copy; <?php echo date('Y');?> <a class="text-bold-800 grey darken-2" href="" ><?=$footer?></a></span><span class="float-md-right d-none d-lg-block">IGLESIA APOSTÓLICA UNIVERSAL DEL NOMBRE DE JESUCRISTO <i class="ft-heart pink"></i><span id="scroll-top"></span></span></p>
    </footer>
    <!-- END: Footer-->
